...
public class WeatherMapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(final LatLng latLng) {
                ...
                final Marker fav = googleMap.addMarker(new MarkerOptions()
                        .position(latLng)
                        .title(cityName)
                        .snippet(countryName));

                Confirmation.confirmAddingPin(fav, context,latLng);
//                if (marker != null) {
//                    marker.remove();
//                }
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo) {
        ...
        if (placeInfo != null) {
            try {
                ...
                //confirm adding
                Confirmation.confirmAddingPin(marker, context,latLng);
